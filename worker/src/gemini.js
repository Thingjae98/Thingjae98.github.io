...
export const TOOL_DECLS = [
  ...
  { name: "search_etf", description: "국내 ETF 1,175종에서 조건에 맞는 것을 찾는다. 테마·자산군·운용사 이름으로 검색하고 순자산이 큰 순으로 나온다. '채권형 ETF 찾아줘', 'AI 반도체 ETF 뭐가 있어', '안전자산 채울 상품' 같은 요청에 쓴다.", parameters: { type: "OBJECT", properties: { query: { type: "STRING", description: "검색어. 예: 반도체, 미국 배당, 국고채, TIGER" }, safe_only: { type: "BOOLEAN", description: "true 면 퇴직연금 100%(안전자산)만" }, asset: { type: "STRING", enum: ["0101", "0102", "0103", "0104", "0105", "0106", "0108"], description: "자산군: 0101주식 0102채권 0103부동산 0104멀티에셋 0105원자재 0106통화 0108단기자금" }, limit: { type: "INTEGER", description: "최대 건수, 기본 12" } } } },
